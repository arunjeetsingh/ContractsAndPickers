    ...
    public sealed partial class PostPhoto : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (_shareOp != null)
            {
                ...
                {
                    var photoItem = await Task.Run(() =>
                    {
                        return PhotoItem.GetPhotoItemAsync(file as StorageFile);
                    });
                    await photoItem.BeginImageRetrieval();
                    _postPhotoModel.FilesToPost.Add(photoItem);
                }
            }
        }
